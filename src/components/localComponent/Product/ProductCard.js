    ...
    <div 
      ...
      <div className="w-full flex flex-row items-center justify-between mx-2">
        <div>
          ...
          <span 
            className="text-red-600 font-semibold text-xs">{price}đ</span>
        </div>
        {isLove || (
          <AiOutlineHeart 
            className="text-red-600 mr-4 text-xs" onClick={handleLove} />
        )}
        {isLove && (
          <AiFillHeart 
            className="text-red-600 mr-4 text-xs" onClick={handleNotLove} />
        )}
      </div>
      ...
      <div className="w-full flex flex-row items-center justify-between mx-2">
        ...
        <span 
            className="text-xs text-headingColor mr-4">
            Rate: {rate}
        </span>
      </div>
